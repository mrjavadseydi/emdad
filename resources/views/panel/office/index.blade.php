    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">ادارات</li>
            </ol>
        </div><!-- /.col -->
    </div>
@endsection
        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title d-inline">لیست ادارات
                    </h3>
                    <a href="{{route('office.create')}}" class="btn btn-sm btn-primary d-inlie" style="float: left">
                        ایجاد اداره جدید
                    </a>
                </div>
                <!-- /.card-header -->
                <div class="table-responsive p-1 " style="overflow: hidden">
                    <table class="table table-striped" id="table-data2">
                        ...
                        <tr>
                            ...
                            <th><input id="title" class="form-control" type="text" placeholder="کد"></th>
                            ...
                            <th><input id="title" class="form-control" type="text" placeholder="ریاست"></th>

                            <th><input id="title" class="form-control" type="text" placeholder="مسئول اشتغال"></th>
